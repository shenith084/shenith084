...
* **AI & Machine Learning**: Specialized in **Computer Vision** and predictive modeling to solve complex real-world challenges.
* **Software Development**: Experienced in building robust full-stack applications using the **MERN stack** and **Flask**.
...
* **Early Detection of Crop Diseases**: My final-year research project utilizing **AI and Computer Vision** to detect agricultural diseases early and improve crop yields.
